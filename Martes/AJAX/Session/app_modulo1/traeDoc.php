<?php
//proteccion de la sesion e incluir datos de sesion
...
try {
    ...
    if ($fpdf_loaded) {
        ...
        if ($image_type) {
            //se fija dimensiones de la imagen
...
function crearPDFSimple($image_blob, $mime_type) {
    ...
    //usar valores por defecto si no se consiguen los de la imagen
    if ($width == 0 || $height == 0) {
        $width = 800;
        $height = 600;
    }
    ...
    //pasamos las dimensiones a puntos
    $pdf_width = ($width / 96) * 72;
